...
WITH raw_data AS (
    SELECT
        ...
        arrival_dttm AS raw_arrival_dttm,
        CAST(arrival_dttm AS TIMESTAMP) AS arrival_dttm,
        close_dttm AS raw_close_dttm,
...
SELECT
    ...
    incident_date,
    call_number,
    raw_alarm_dttm AS alarm_dttm_raw,
    alarm_dttm,
    raw_arrival_dttm AS arrival_dttm_raw,
    arrival_dttm,
    raw_close_dttm AS close_dttm_raw,
    close_dttm,
    first_unit_on_scene,
    number_of_alarms,
    primary_situation,
